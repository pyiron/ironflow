...
class TestGUI(TestCase):
    ...
    def test_multiple_scripts(self):
        gui = GUI('foo')
        gui.workflows_screen.flow_canvas.add_node(0, 0, gui.nodes_dictionary['built_in']['val'])
        gui.create_script()
        gui.workflows_screen.flow_canvas.add_node(1, 1, gui.nodes_dictionary['built_in']['result'])
    ...
    def test_saving_and_loading(self):
        title = 'foo'
        gui = GUI(title)
        canvas = gui.workflows_screen.flow_canvas
    ...
    def test_user_node_registration(self):
        ...
        gui.workflows_screen.flow_canvas.add_node(0, 0, gui.nodes_dictionary["user"][MyNode.title])
        ...
        gui.workflows_screen.flow_canvas.add_node(1, 1, gui.nodes_dictionary["user"][MyNode.title])
